...
class ImageInput extends React.Component {
  static propTypes = {
    ...
    handlerFileSelectedCallback: PropTypes.func
  };
  ...
  state = {
    ...
    handlerFileSelectedCallback = (event) => {
    const file = event.target.files[0];
    this.props.handlerFileSelectedCallback(file);
    ...
    return (
      <div className={className} style={style}>
        ...
        <input
          ...
          type="file"
          onChange={this.handlerFileSelectedCallback}
          style={{
            position: 'absolute',
            top: 0,
            left: 0,
